...
| `/cash-for-junk-cars`                        | Commercial               | cash for junk cars                             | vehicle offer request, junk car value factors, unwanted car buyer | Service                  |
...
| `/get-cash-offer`                            | Transactional            | request junk car offer                         | vehicle details form, cash-offer request                          | WebPage                  |
...
| `/faq`                                       | Informational            | junk car sale questions                        | title, keys, non-running cars, pickup timing, hours               | FAQPage                  |
...
1. Home links to every core service, both area pages, the recycling guide, FAQ, and offer form.
2. Service pages link to offer form, call action, and relevant FAQs.
3. Area pages link to offer form and service-area hub.
